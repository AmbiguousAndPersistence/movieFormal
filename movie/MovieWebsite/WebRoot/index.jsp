		...
		<div class="nav-secondary">
			...
			<div class="nav-items">
				<ul>
					...
					<li><a href="${basePath }film/query_count">2017评分最高电影片单</a></li>
				</ul>
			</div>
					...
					<div id="screening" class="s" data-dstat-areaid="70"
						...
						<div class="screening-bd tab-content" style="overflow:auto; ">
							<div class="tab-pane active" id="panel-449764">
								<ul class="ui-slide-content" id="newFilm">
				...
				<div class="aside">
					...
					<div id="billboard" class="s" data-dstat-areaid="75"
						...
						<div class="billboard-hd">
							<h2>
								本周推荐电影<span><a href="/chart">我来推荐&raquo;</a></span>
							</h2>
						</div>
	...
	<script type="text/javascript">
		...
		(function() {
			$
					.ajax({
						type : "post",
						url : "${basePath}/film/index_query",
						dataType : "json",
						success : function(jsonData) {
							var newFilm = document.getElementById("newFilm");
							newFilm.innerHTML = "";
							var len = jsonData.rows.length;
							for (var i = 0; i < len; i++) {
								newFilm.innerHTML += " <li  class=\"ui-slide-item\">\n"
										+ "   <ul class=\"\">\n"
										+ "    <li class=\"poster\"><a target='_blank' \n"
										+ "        href=\"${basePath }film/query_ById?film_id="
										+ jsonData.rows[i].film_id
										+ "\">\n"
										+ "                  <img src=\"/img/"+jsonData.rows[i].film_pic+"\" alt=\""+jsonData.rows[i].film_name+"\"\n" +
                        "                            rel=\"nofollow\" class=\"\">\n"
										+ "                                 </a></li>\n"
										+ "                                       <li class=\"title\"><a target='_blank' \n"
										+ "                                             onclick=\"moreurl(this, {from:'mv_a_tl'})\"\n"
										+ "                                                href=\"https://movie.douban.com/subject/25889465/?from=showing\"\n"
										+ "                                                  class=\"\">"
                        ...
                        "                                                  style=\"color: #e09015;\"> "
										...
										+ " </strong></a></li>\n"
										+ "                                            <li><p title=\""+jsonData.rows[i].short_comment+"\"\n" +
                        "                                      style=\"color: #999;font-size: 12px;margin: 5px 0 0;\">\n"
										+ "                     "
